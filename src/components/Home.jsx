    ...
    >
      <div className="max-w-screen-xl mx-auto px-6 md:px-12 flex flex-col items-center justify-center gap-12 md:flex-row">
        ...
        <div className="md:w-1/3 w-full flex justify-center">
          <img
            src={profileImage}
            alt="DJEGHABA MOHAMMED BAHA EDDINE"
        ...
        <div className="md:w-2/3 text-center md:text-left">
          ...
          <p className="mt-6 text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto md:mx-0">
            Diplômé en ingénierie des réseaux industriels et intelligence artificielle, avec un Master en télécommunications.
            Compétences solides en systèmes informatiques, développement web (MERN, Flutter), cybersécurité et solutions IA/IoT.
            Passionné par l’innovation numérique et les systèmes distribués performants.
          </p>
